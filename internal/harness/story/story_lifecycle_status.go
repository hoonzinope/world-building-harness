...
func (s *Store) archiveStory(storyID, actorID string) error {
	return s.changeStoryLifecycleStatus(storyID, actorID, "archived", "story_archived")
}
func (s *Store) restoreStory(storyID, actorID string) error {
	return s.changeStoryLifecycleStatus(storyID, actorID, "active", "story_restored")
}
func (s *Store) deleteStory(storyID, actorID string) error {
...
func (s *Store) updateDriver(storyID string, u *Actor, action string) error {
