...
func (s *Store) exportStoryBundle(storyID string, actor *Actor) (string, error) {
...
func turnHashes(turns []Turn) []map[string]any {
...
func renderStoryletBundle(m Manifest, st State, turns []Turn) string {
