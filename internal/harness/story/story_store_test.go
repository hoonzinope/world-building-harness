...
func TestStoryReadTurnsRejectsMalformedMiddleLine(t *testing.T) {
	...
	good, err := json.Marshal(Turn{TurnID: 1, BranchID: "branch_main", ActorID: "user_admin", InputID: "input_1", Source: "setup", SceneTitle: "Turn 1", SceneBody: "first", CurrentSituation: "situation 1", CreatedAt: "2026-06-07T00:00:00Z"})
	if err != nil {
		t.Fatal(err)
	}
	bad := []byte(`{"turn_id":2,"branch_id":"branch_main"`)
	third, err := json.Marshal(Turn{TurnID: 3, BranchID: "branch_main", ParentTurnID: 2, ActorID: "user_admin", InputID: "input_3", Source: "choice", SceneTitle: "Turn 3", SceneBody: "third", CurrentSituation: "situation 3", CreatedAt: "2026-06-07T00:02:00Z"})
	if err != nil {
		t.Fatal(err)
	}
...
func TestStoryRecoverRepairsPartialTailsAndRemovesStaleLock(t *testing.T) {
	...
	turn1 := Turn{TurnID: 1, BranchID: "branch_main", ActorID: "user_admin", InputID: "input_1", Source: "setup", SceneTitle: "Turn 1", SceneBody: "one", CurrentSituation: "situation 1", CreatedAt: "2026-06-07T00:00:00Z"}
	turn2 := Turn{TurnID: 2, BranchID: "branch_main", ParentTurnID: 1, ActorID: "user_admin", InputID: "input_2", Source: "choice", SceneTitle: "Turn 2", SceneBody: "two", CurrentSituation: "situation 2", CreatedAt: "2026-06-07T00:01:00Z"}
	...
	q1 := Question{ID: "q1", ActorID: "user_admin", Question: "where?", Answer: "here", TurnID: 1, CreatedAt: "2026-06-07T00:00:00Z"}
	q2 := Question{ID: "q2", ActorID: "user_admin", Question: "why?", Answer: "because", TurnID: 2, CreatedAt: "2026-06-07T00:01:00Z"}
