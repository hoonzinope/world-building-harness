...
func storyRoomTemplateData(base, id string, u *authUser, m storyManifest, st storyState, displayTurns, previousTurns []storyTurn, qa []storyQuestion, canDrive, canClaim, canRelease, canQuestion, isAdmin, canAdminMutate bool, latestTurnID int, latestTurn any, hasTurns bool, driverLabel string, isProcessing bool, progress storyProgressView, failedJob *failedJobView, query url.Values, csrf string) map[string]any {
	playerDossier := storyRoomPlayerDossierViewFromState(st)
	turnPreviews := storyRoomTurnPreviews(displayTurns)
	previousTurnPreviews := storyRoomTurnPreviews(previousTurns)
	return map[string]any{
		"Base":                 base,
		"User":                 u,
		"IsAnonymous":          u == nil,
		"Story":                storyRoomStoryViewFromManifest(m),
		"State":                playerDossier,
		"PlayerDossier":        playerDossier,
		"Turns":                turnPreviews,
		"TurnPreviews":         turnPreviews,
		"PreviousTurns":        previousTurnPreviews,
		"PreviousTurnPreviews": previousTurnPreviews,
		"QA":                   qa,
		"CanDrive":             canDrive,
		"CanClaim":             canClaim,
		...
		"LatestTurn":           storyRoomVisibleLatestTurn(latestTurn),
		"HasTurns":             hasTurns,
		"DriverLabel":          driverLabel,
		"IsProcessing":         isProcessing,
		"Progress":             progress,
		"StatusURL":            base + "/stories/" + url.PathEscape(id) + "/status",
		"FailedJob":            storyRoomFailedJobNoticeFromFailedJob(failedJob),
		"AdminData":            storyRoomAdminDataFor(isAdmin, m, st, displayTurns, previousTurns, qa, latestTurn, failedJob),
