...
## 1. 방향
로드맵은 거대한 멀티 에이전트 시스템을 바로 만드는 것이 아니라, 안전한 단일 workflow에서 시작해 OpenCrab 연동, 승인 플로우, 그래프 인덱스, 멀티 에이전트로 점진 확장하는 방식으로 진행한다.
...
## 6. Phase 4: OpenCrab Adapter
### 목표
OpenCrab에서 world-harness CLI를 호출할 수 있게 한다.
...
## 9. Phase 7: Multi-Agent Orchestration
### 목표
...
## 10. Phase 8: Search & Semantic Context
### 목표
관련 문서 로딩 품질을 높인다.
